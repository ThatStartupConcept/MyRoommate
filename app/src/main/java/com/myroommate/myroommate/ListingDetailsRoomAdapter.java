...
public class ListingDetailsRoomAdapter extends RecyclerView.Adapter<ListingDetailsRoomAdapter.RoomCardHolder> {
    ...
    ListingDetailsRoomAdapter(String primary_key, final Activity currentActivity, Context currentContext, final View currentView, final ArrayList<ArrayList<Integer>> listOfRooms) {
            ...
            public void onResponse(String stringResponse) {
                ...
                if (!stringResponse.equals("Listing not found.")) {
                    ...
                    try {
                        ...
                        final BedImageAdapter mAdapter = new BedImageAdapter(listOfBeds);
